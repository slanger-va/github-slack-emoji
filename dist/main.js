...
/* harmony import */ var _creds__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../creds */ "./creds.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        return this.http.get('./assets/emoji.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((function (result) {
            if (result) {
                ...
                result.map(function (r) {
                    for (var i = 0; i < r['short_names'].length; i++) {
                        emojiMap_1[r['short_names'][i]] = r['unified'];
                    }
                });
                return emojiMap_1;
            }
...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<div style=\"text-align:center\">\n  <h1>\n    Welcome to VSlack-moji!\n  </h1>\n  <ng-container *ngIf=\"slackEmojies$ | async as slackEmojies\">\n    <ng-container *ngIf=\"customEmojies$ | async as customEmojies\">\n      <input matInput placeholder=\"Search by emoji\" [formControl]=\"emojiControl\">\n      <img class=\"imageSize\" src=\"{{customEmojies[emojiControl.value]}}\">\n      <div class=\"imageSize\">{{slackEmojies[emojiControl.value]}}</div>\n    </ng-container>\n  </ng-container>\n</div>\n\n<router-outlet></router-outlet>\n"
...
module.exports = ".imageSize {\n  width: 14px;\n  height: 14px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(appService) {
        this.fontSize = 14;
        this.emojiControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]();
...
module.exports = __webpack_require__(/*! /Users/slanger/side projects/Slack-Extension/slack-extension/src/main.ts */"./src/main.ts");
